...
export const metadata = {
  title: "Privacy Policy - Smart QR & Barcode",
  description: "Privacy Policy for Smart QR & Barcode Generator",
};
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg prose-blue mx-auto">
          <p>
            This Privacy Policy explains how Smart QR &amp; Barcode (the “Service”) collects,
            uses, and shares information when you use our website and related features.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Authentication data</strong>: If you sign in with Google, we receive an
              identifier and profile information made available by Google based on your settings.
            </li>
            <li>
          ...
          <p>
            Content you enter to generate QR codes or barcodes is intended to be processed to
            deliver the feature. Whether any content is stored depends on the specific feature
            you use (for example, saving projects or usage analytics).
          </p>
